...
class AlreadyInitialized(PooledDBError):
	"""Pool have been already initialized."""
...
class PooledDB(object):
	...
	def __init__(self, creator,
		...
		"""
		if self._count > 1:
		    raise AlreadyInitialized('PooledDB already initialized.')
		self._count += 1
		...
		if maxconnections is None:
			maxconnections = 0
		if mincached > maxconnections:
			raise PooledDBError('MinCached conncetions greater then MaxConncetions')
		if maxcached:
