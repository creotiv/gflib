...
from gflib.db.SteadyDB import connect as SteadyDBconnect
from gflib.db.SteadyDB import SteadyDBConnection, SteadyDBCursor


class TestSteadyDB(unittest.TestCase):

    def test00_CheckVersion(self):
        from gflib.db.SteadyDB import __version__ as SteadyDBVersion
