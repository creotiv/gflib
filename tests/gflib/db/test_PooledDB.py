...
# The test_SteadyDB module serves as a mock object for the DB-API 2 module:
import test_SteadyDB as dbapi
from gflib.db.PooledDB import PooledDB


class TestPooledDB(unittest.TestCase):

    def test00_CheckVersion(self):
        from gflib.db.PooledDB import __version__ as PooledDBVersion
